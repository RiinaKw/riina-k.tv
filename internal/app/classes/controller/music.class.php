...
class Controller_Music extends Controller_Base {
	...
	{
		$track['detail_url'] = $this->root . '/music/' . $track['slug'];
		if ( $track['preview_url'] ) {
			$track['preview_url'] = $this->root . $track['preview_url'];
		}
		if ( $track['image_name'] != '' ) {
			$track['image_url'] = $this->root . '/artwork/' . $track['image_name'];
		} else {
			$track['image_url'] = $this->root . '/images/no-jacket.jpg';
		}
	}
